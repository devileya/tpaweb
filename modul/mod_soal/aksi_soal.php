...
if( $file['error'] == 0 )
{
 ...
 mysql_query("INSERT INTO tbl_soal	(nama_kategori, soal, a, b, c, d, e, pmbahasn, jwaban, gambar,id_teks,level) 
                            VALUES('$_POST[nama_kategori]', '$_POST[soal]', '$_POST[a]', '$_POST[b]', '$_POST[c]', '$_POST[d]', '$_POST[e]', '$_POST[pmbahasn]', '$_POST[jwaban]', '$file_name',$_POST[teks],$_POST[level])");
  header('location:../../media.php?module='.$module);
}

// Update soal
elseif ($module=='soal' AND $act=='update'){
  mysql_query("UPDATE tbl_soal SET nama_kategori = '$_POST[nama_kategori]',
                 soal = '$_POST[soal]',
                 a = '$_POST[a]',
                 b = '$_POST[b]',
                 c = '$_POST[c]',   
